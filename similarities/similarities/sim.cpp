...
double cosine(double sz1, double sz2, double num);
int main()
{
	//int choice;
	...
	cout << "The coeficient of similarity betwen the querry and the first doc is " << cosine(size1, size3, num1) << " .\n";
	cout << "The coeficient of similarity betwen the querry and the second doc is " << cosine(size2, size3, num2) << " .\n";
	cin >> letter;
...
double cosine(double sz1, double sz2, double num)
{
	...
	//cout << sz1 << endl; much debugging to find why numbers were not passing
	//cout << sz2 << endl;
	sqr1 = sqrt(sz1);
	sqr2 = sqrt(sz2);
	//cout << sqr1 << endl;
